...
// ----------------------------------------------------------------------------------------
// used https://github.com/NVlabs/ffhq-dataset for faces
// The next bit of code defines a ResNet network. 
// It's basically copied  and pasted from the dnn_imagenet_ex.cpp example, http://dlib.net/dnn_imagenet_ex.cpp.html
// except I replaced the loss layer with loss_metric and made the network somewhat smaller. 
//  If need help go read the introductory dlib DNN examples to learn how to define a CNN in C++.
//
